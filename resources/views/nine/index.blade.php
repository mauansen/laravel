...
<head>
    ...
    <link href="{{asset('css/style.css?v=4.1ddddff.0')}}" rel="stylesheet">
</head>
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="{{url('nine/goods_save')}}">商品添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('nine/goods_show')}}">商品展示</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('nine/attr_save')}}">属性添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('nine/attr_show')}}">属性展示</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('nine/cate_save')}}">分类添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('nine/cate_show')}}">分类展示</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('nine/type_save')}}">类型添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('nine/type_show')}}">类型展示</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('nine/stock_run')}}">库存管理</a>
                        </li>
                    </ul>
                </li>
{{--                <li class="line dk"></li>--}}
...
{{--        <div class="row J_mainContent" id="content-main">--}}
            <iframe id="J_iframe" width="100%" height="100%" src="{{url('nine/index_v1')}}" frameborder="0" data-id="index_v1.html" seamless></iframe>
        </div>
    </div>
    <!--右侧部分结束-->
</div>
